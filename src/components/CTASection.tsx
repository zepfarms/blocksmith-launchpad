...
export const CTASection = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-black to-gray-900 py-20 overflow-hidden max-w-full">
            ...
            <div className="relative z-10 max-w-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full px-2">
                <button
                  ...
                  className="group w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-white text-black rounded-full font-medium text-base sm:text-lg hover:bg-gray-100 transition-all duration-200 shadow-lg inline-flex items-center justify-center gap-2 hover-scale"
                >
                  Start Building Free
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 border-2 border-white/20 text-white rounded-full font-medium text-base sm:text-lg hover:bg-white/5 transition-all duration-200 inline-flex items-center justify-center gap-2"
                >
