export const BetaSection = () => {
  return (
    <section className="relative py-16 sm:py-24 md:py-32 px-4 sm:px-6">
      ...
      <div className="absolute top-1/2 left-1/2 w-[400px] sm:w-[600px] md:w-[800px] h-[400px] sm:h-[600px] md:h-[800px] bg-neon-cyan/10 rounded-full blur-[150px] -translate-x-1/2 -translate-y-1/2 animate-glow-pulse" />

      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="relative p-6 sm:p-10 md:p-16 rounded-2xl sm:rounded-[2rem] glass-card border border-neon-cyan/20 shadow-[0_0_80px_rgba(34,211,238,0.2)] overflow-hidden">
          {/* Inner ambient glow */}
          ...
          <div className="relative z-10 space-y-8 sm:space-y-12">
            ...
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter px-2">
              ...
              <div className="max-w-3xl mx-auto pt-2 sm:pt-4 px-4">
                <p className="text-sm sm:text-base md:text-lg text-foreground/90 leading-relaxed font-light">
