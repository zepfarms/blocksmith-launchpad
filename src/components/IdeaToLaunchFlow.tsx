          ...
          <div className="w-full max-w-4xl">
            ...
            <div className="relative mx-auto rounded-2xl rounded-b-lg border border-glass-border bg-gradient-to-b from-card/50 via-background to-background shadow-premium">
              ...
              <div className="mx-4 mb-4 rounded-xl border border-border bg-background overflow-hidden">
                <div className="relative h-[260px] sm:h-[280px] lg:h-[300px] bg-gradient-to-b from-card/90 via-background to-background">
...
function Step1Slide({ pulse }: { pulse: boolean }) {
  return (
    <div className="flex h-full flex-col">
      ...
      <button
        className={`mt-4 inline-flex items-center rounded-full border border-border bg-card/80 px-4 py-1.5 text-xs sm:text-sm text-foreground ${
          pulse ? "cta-pulse" : ""
        }`}
      >
        Continue
...
function Step2Slide({ pulse }: { pulse: boolean }) {
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="mt-3 flex items-center gap-2 text-[0.7rem] sm:text-xs text-muted-foreground">
        <span className="h-2 w-2 rounded-full bg-acari-green shadow-acari-glow" />
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="mt-3 rounded-xl border border-border bg-card/80 p-3">
        {items.map((label) => (
          <div
            key={label}
            className="mb-1.5 flex items-center justify-between text-xs sm:text-[0.78rem] text-foreground"
          >
            <span>{label}</span>
      ...
      <button
        className={`mt-3 inline-flex items-center rounded-full border border-border bg-card/80 px-4 py-1.5 text-xs sm:text-sm text-foreground ${
          pulse ? "cta-pulse" : ""
        }`}
      >
        Continue
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-border bg-card/80 p-3 text-xs sm:text-[0.78rem]">
      ...
      <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-acari-green/80 bg-acari-green/15 px-3 py-1.5 text-xs sm:text-sm text-acari-green">
        <span className="h-2 w-2 rounded-full bg-acari-green shadow-acari-glow" />
